---
layout: post
title: React 源码剖析系列 － 不可思议的 react diff (转)
description: 目前，前端领域中 React 势头正盛，使用者众多却少有能够深入剖析内部实现机制和原理。本系列文章希望通过剖析 React 源码，理解其内部的实现原理，知其然更要知其所以然。
category: blog
---
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff01.png)
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff02.png)
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff03.png)
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff04.png)
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff05.png)
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff06.png)
...
![](http://7o524n.com1.z0.glb.clouddn.com/diff07.png)
...
* [A Survey on Tree Edit Distance and Related Problems](http://link.zhihu.com/?target=http%3A//grfia.dlsi.ua.es/ml/algorithms/references/editsurvey_bille.pdf)

* [Reconciliation](http://link.zhihu.com/?target=http%3A//facebook.github.io/react/docs/reconciliation.html)